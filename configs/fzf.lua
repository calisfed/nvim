...
vim.keymap.set({ 'n', 'v' }, '<leader>sf', function() require('fzf-lua').files(from_git_root()) end,
    { desc = 'Search Files' })
vim.keymap.set({ 'n', 'v' }, '<leader>sg', function() require('fzf-lua').live_grep(from_git_root()) end,
    { desc = 'Search Grep' })
...
vim.keymap.set({ 'n', 'v' }, '<leader>sn', '<cmd>FzfLua files cwd=$HOME/.config/nvim/<CR>',
...
vim.keymap.set({ 'n', 'v' }, '<leader>sct', '<cmd>FzfLua lsp_type_definitions<cr>',
    { desc = 'Code go to Type definitions' })
vim.keymap.set({ 'n', 'v' }, '<leader>scr', '<cmd>FzfLua lsp_references<cr>', { desc = 'Code go to References' })
vim.keymap.set({ 'n', 'v' }, '<leader>scD', '<cmd>FzfLua lsp_document_diagnostics<cr>',
