  ...
  lsp_completion = {
    ...
    process_item = function(items, base)
      return MiniCompletion.default_process_items(items, base, {
        filtersort = 'fuzzy',         -- none | prefix | fuzzy
...
map_multistep('i', '<Tab>',
  { 'pmenu_accept', 'pmenu_next', 'minisnippets_next', 'vimsnippet_next', 'luasnip_next', 'minisnippets_expand',
    'increase_indent', 'jump_after_close' })
