  ...
  config = function()
    ...
    require('mini.starter').setup({
      ...
      items = {
        ...
        { name = 'Files in cwd',    action = ':lua require("snacks").picker.files({ cwd = Snacks.git.get_root(), sort = { fields = { "left", "score:desc", "#text", "idx" } }})', section = 'Commands' },
...
██████  █████████████████████ ████ █████ █████ ████ ██████
    ...
    --   callback = function()
    --     vim.keymap.set("c", "<Tab>", "<Cr>", { buffer = true })
    --   end,
    -- })
