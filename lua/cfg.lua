return {
  ...
  { enabled = true,  'mcauley-penney/techbase.nvim',             priority = 1000, },
  ...
  { enabled = false, 'hamidi-dev/kaleidosearch.nvim', },       -- color keyword
  ...
  { enabled = false, 'saxon1964/neovim-tips' },                -- Tips, currently only support fzf-lua
  ...
  { enabled = false, 'B00TK1D/neoghidra' },               -- Reverse engineering
  ...
  { enabled = false, 'iamcco/markdown-preview.nvim' },             -- Another markdown-preview
